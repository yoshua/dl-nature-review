...
molecules~\citep{DahlKaggle}, detecting new fundamental
...
cells in visual neuroscience~\cite{Hubel1962}, and the overall
...
the sequence of characters in the transcription.  They
...
sign recognition~\cite{sermanet-ijcnn-11,schmidhuber-traffic}, the
segmentation of biological images~\cite{ning-05} particularly for
connectomics~\cite{seung-xx}, the detection of faces, text, and human bodies in natural
images~\cite{vaillant-monrocq-lecun-94,nowlan-platt-95,garcia-delakis-04,osadchy-07,nasse-09,taylor-xx,sermanet-cvpr-13,thompson-14}.
...
natural language understanding~\cite{collobert-weston-xx}, and speech
...
\caption{Examples of captions generated by a recurrent network taking
...
images into captions. Reproduced with permission from~\citet{Vinyals-et-al-arxiv2014}.
}
\end{minipage}
}
