...
dominant only now? The idea of convexity of the objective function grew
as an attractive property of learning algorithms, thanks to the success
of kernel machines, which made neural nets (that involve a non-convex
training criterion) less appealing. As discussed below, it is only
in 2014 that theoretical and empirical evidence have suggested that local
minima are probably not as much of a problem as was initially thought~\citep{Dauphin-et-al-NIPS2014-small,Choromanska-et-al-AISTATS2015}.
Much before that realization, though, a number of recent
ideas and technologies enabled the success. First, supervised ConvNets work best
...
networks. The gradient with respect to a recurrent weight,
...
and ways of training them~\citep{Sutskever-thesis2012}, recurrent networks 
