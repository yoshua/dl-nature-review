...
of processing to learn to represent data, so that each layer transform
...
data, such as images, video, speech and audio, while {\em recurrent
  net} have shown excellent performance for analyzing sequential
inputs and producing sequential outputs such as text and
speech. Convolutional net has quickly become the leading for image
...
recogntion or ML system has required engineering efforts and domain
...
object, and subsequent layers would detect objects as combinations of
...
%% YLC: I moved this section down from the intro. It was redundant there.
%% Some of it is probably redundant with much of what follows
...
%% YLC: This is where the original recurrent net section begins.
%% There should be some merging between the stuff above and the stuff below.
