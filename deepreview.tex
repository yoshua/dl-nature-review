...
a high-dimensional space~\cite{Cover65}. In the limit when there are at least
...
developed by many of the major speech groups\cite{Hinton-et-al-2012} and were already
...
hand-writing~\cite{Graves-et-al-2009}. They have subsequently proved to be very
...
games~\cite{Deepmind-atari-arxiv2013}. The system uses a deep convolutional network to
