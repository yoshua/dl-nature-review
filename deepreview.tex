...
the chain rule of derivatives,  % clarifying which chain rule, not the probabilities one
...
that creates a change $\Delta z$ in $z$. Inserting one equation
...
\begin{equation}
y_j = \frac{1}{1+ e^{z_j}}, \ \ \ y_j = \frac{e^{z_j}-e^{-z_j}}{e^{z_j}+e^{-z_j}} % YB: what was the intent here for the 2nd part?
\end{equation}
