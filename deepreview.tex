...
molecules~\citep{DahlKaggle}, detecting new fundamental particles~\citep{YANNparticles},
classifying galaxies~\citep{YANNgalaxies}, and predicting the effects of mutations in
non-coding DNA on gene expression and disease~\citep{Keung-et-al-2014}. % Frey
...
initial hidden state (or as extra input) of a trained French ``decoder'' 
...
network (Figures~\ref{fig:backprop-box} and~\ref{fig:mlp}). 
