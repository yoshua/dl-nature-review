...
Designing good feature extractors traditionally required a considerable amount
...
with many layers. Units that are not in the input or output layer are
...
speech recognition~\citep{TDNN} and document reading~\citep{lecun-98}. 
...
new combinations of the learned features (e.g. $2^n$ combinations,
with $n$ features) ~\citep{Bengio-2009-book,Montufar+Morton-2014}.
Second composing layers in a deep net brings the potential for another
...
Unsupervised learning~\citep{Salakhutdinov2009-small,Hinton95,VincentPLarochelleH2008-small,
