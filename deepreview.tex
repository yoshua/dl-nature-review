...
especially for video understanding or robotics, to come from systemsthat
...
attending to one part at a time\cite{Yoshua translation}. We also expect
...
achievments and we have ignored much interesting work on unsupervised
...
and documents~\cite{Yann, Yoshua: untangling papers}.

Finally, we believe that the recent successes of deep learning using
stochastic gradient descent are only the beginning.  End-to-end learning
