...
and many other domains such as drug discovery and genommics. Deep
...
neural networks, becoming quite popular in the late 1980s, but fell out of favor
between the mid 1990s until its rennaissance in the late 2000s.
...
words~\cite{WaibelIEEE,bottou-89}
...
images~\cite{vaillant-monrocq-lecun-94,nowlan-platt-95,garcia-delakis-04,osadchy-07,
  nasse-09,fan-pami-2010,sermanet-cvpr-13,Tompson-et-al-arxiv2014}.
A major practical success of ConvNets in recent times is face
recognition~\citep{taigman-cvpr-2014}. A recent stunning demonstration
of ConvNets is the generation of image captions, as shown in
...
such as Mobileye and NVIDIA are using ConvNets in their upcoming
vision systems for cars.  Other applications of ConvNets that are
gaining importance concern natural language
...
ConvNets are easily ammenable to efficient hardware implementations in
...
LSTM have subsequently proved to be very effective for tasks that have
sequential input.  When they use several hidden layers, they are
better than deep feedforward networks for speech
recognition~\citep{Graves-et-al-ICASSP2013} and unlike feedforward
nets they can implement an entire speech recognition system that goes
all the way from coefficents derived from the soundwave to the
...
where to look through reinfoercement learning. Such systems already
...
part at a time~\citep{Bahdanau-et-al-ICLR2015}. 
...
%% YLC: I uncommented this. I really think this is were things are going.
